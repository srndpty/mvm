...
param(
    ...
    [ValidateSet('CONTROL','TARGET_RHIITEM_PIXEL_TOGGLE','EXTERNAL_DIRTY')][string]$Condition,
...
$windowMode=if($Condition-eq'EXTERNAL_DIRTY'){'VISIBLE_UNOCCLUDED_FORCE_DIRTY'}else{'VISIBLE_UNOCCLUDED'}
