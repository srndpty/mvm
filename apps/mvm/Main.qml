...
ApplicationWindow {
    ...
    Connections {
        ...
        function onStateChanged() { root.syncEffectInspector() }
    }
    ...
    ColumnLayout {
        ...
        Frame {
            ...
            contentItem: RowLayout {
                spacing: 5
                EffectSpinEditor { id: positionX; labelText: "位置 X (%)"; from: -1000; to: 1000 }
                EffectSpinEditor { id: positionY; labelText: "位置 Y (%)"; from: -1000; to: 1000 }
                EffectSpinEditor { id: scale; labelText: "拡大率 (%)"; from: 1; to: 1000 }
                EffectSpinEditor { id: rotation; labelText: "回転 (°)"; from: -360; to: 360 }
                EffectSpinEditor { id: opacity; labelText: "不透明度 (%)"; from: 0; to: 100 }
                EffectSpinEditor { id: cropLeft; labelText: "Crop 左 (%)"; from: 0; to: 99 }
                EffectSpinEditor { id: cropTop; labelText: "Crop 上 (%)"; from: 0; to: 99 }
                EffectSpinEditor { id: cropRight; labelText: "Crop 右 (%)"; from: 0; to: 99 }
                EffectSpinEditor { id: cropBottom; labelText: "Crop 下 (%)"; from: 0; to: 99 }
                EffectSpinEditor { id: fadeIn; labelText: "フェードイン（素材フレーム）"; from: 0; to: 1000000 }
                EffectSpinEditor { id: fadeOut; labelText: "フェードアウト（素材フレーム）"; from: 0; to: 1000000 }
                Button {
                    text: "適用"
                    enabled: !mvmController.busy && !mvmController.playing
                    onClicked: mvmController.applyCurrentClipEffects(
                                   positionX.value, positionY.value, scale.value,
                                   rotation.value, opacity.value, cropLeft.value,
                                   cropTop.value, cropRight.value, cropBottom.value,
