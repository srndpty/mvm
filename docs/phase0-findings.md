...
MLT と ffprobe の解析結果を全項目で比較した。

| 素材 | codec | 解像度 | fps | frame_count | duration | 音声 | 結果 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `v1080p60_h264` | h264 | 1920x1080 | 60/1 | 300 | 5.000 | aac 48000/2ch | 一致 |
| `v1080p60_hevc` | hevc | 1920x1080 | 60/1 | 300 | 5.000 | aac 48000/2ch | 一致 |
| `v4k60_h264` | h264 | 3840x2160 | 60/1 | 300 | 5.000 | aac 48000/2ch | 一致 |
| `v4k60_hevc10` | hevc | 3840x2160 | 60/1 | 300 | 5.000 | aac 48000/2ch | 一致 |
| `png_alpha` | png | 512x512 | — | — | — | — | 一致（尺は比較対象外） |
| `wav_48k` | — | — | — | — | 5.000 | pcm_s16le 48000/2ch | 一致 |
