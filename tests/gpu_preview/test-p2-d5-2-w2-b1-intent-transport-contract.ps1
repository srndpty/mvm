...
param(
    [Parameter(Mandatory=$true)][ValidateSet(
        'GoodFormal','GoodNonFormal','GoodSuppressedFormal','NegativeAppV5QtV6','NegativeAppV6QtV5',
...
switch($Case){
    ...
    'NegativeAppV5QtV6'{$transport.app_abi_version=5}
    'NegativeAppV6QtV5'{$transport.qt_abi_version_observed=5;$hook.qt_abi_version_observed=5}
