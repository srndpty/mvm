...
Require -Text $core -Pattern 'exactMembershipOrdinals[\s\S]+REQUIRED_SET_DECISION_MEMBERSHIP_SET_MISMATCH' -Message 'required setとexact decision membership setの一致を要求していません'
...
Require -Text $controller -Pattern 'mvm-p2-d5-2-w2-c21-intent-authority-provenance-2' -Message 'C2.1 authority追加後のschemaを識別できません'
